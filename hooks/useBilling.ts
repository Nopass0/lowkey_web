...
const MOCK_PLANS: SubscriptionPlan[] = [
  {
    id: "starter",
    name: "Начальный",
    prices: { monthly: 99, "3months": 89, "6months": 79, yearly: 69 },
    features: ["1 устройство", "50 МБит/с", "Базовая защита"],
  },
  {
    id: "pro",
    name: "Рабочий",
    prices: { monthly: 199, "3months": 179, "6months": 159, yearly: 139 },
    features: ["3 устройства", "200 МБит/с", "Без логов", "Kill Switch"],
    isPopular: true,
  },
  {
    id: "advanced",
    name: "Продвинутый",
    prices: { monthly: 349, "3months": 299, "6months": 269, yearly: 229 },
    features: [
