...
const plans = [
  {
    ...
    name: "Начальный",
    basePrice: 349,
    features: ["1 устройство", "До 100 Мбит/с", "Базовая защита"],
  },
  {
    id: "pro",
    name: "Рабочий",
    basePrice: 499,
    popular: true,
    features: ["3 устройства", "До 500 Мбит/с", "Приоритетный сервер"],
  },
  {
    id: "advanced",
    name: "Продвинутый",
    basePrice: 699,
    features: ["∞ устройств", "До 1 Гбит/с", "Выделенный сервер"],
  },
];
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <CardHeader
                    className={`pb-0 text-center ${plan.popular ? "pt-9" : "pt-6"}`}
                  >
